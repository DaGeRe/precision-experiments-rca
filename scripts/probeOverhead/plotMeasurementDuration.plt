...
plot 'outputCSVs/measurementDurations.csv' u 1:4 w linespoint lc "red" title 'AspectJ Instrumentierung', \
	'outputCSVs/measurementDurations.csv' u 1:($4*(1-$5)):($4*(1+$5)) w filledcurves lc "red" notitle fs transparent solid 0.5, \
     'outputCSVs/measurementDurations.csv' u 1:6 w linespoint lc "yellow" title 'Quelltextinstrumentierung', \
	'outputCSVs/measurementDurations.csv' u 1:($6*(1-$7)):($6*(1+$7)) w filledcurves lc "yellow" notitle fs transparent solid 0.5, \
     'outputCSVs/measurementDurations.csv' u 1:8 w linespoint lc "green" title 'Quelltextinstrumentierung und selektiver Instrumentierung', \
	'outputCSVs/measurementDurations.csv' u 1:($8*(1-$9)):($8*(1+$9)) w filledcurves lc "green" notitle fs transparent solid 0.5 , \
...
plot 'outputCSVs/measurementDurations.csv' u 1:10 w linespoint lc "red" title 'AspectJ Instrumentierung', \
	'outputCSVs/measurementDurations.csv' u 1:($10*(1-$11)):($10*(1+$11)) w filledcurves lc "red" notitle fs transparent solid 0.5, \
     'outputCSVs/measurementDurations.csv' u 1:12 w linespoint lc "yellow" title 'Quelltextinstrumentierung', \
	'outputCSVs/measurementDurations.csv' u 1:($12*(1-$13)):($12*(1+$13)) w filledcurves lc "yellow" notitle fs transparent solid 0.5, \
