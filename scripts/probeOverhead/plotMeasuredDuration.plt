...
plot 'pure_durations.csv' u 1:8 w linespoint lc "red" title 'AspectJ Instrumentierung', \
	'pure_durations.csv' u 1:($8-$9):($8+$9) w filledcurves lc "red" notitle fs transparent solid 0.5, \
     'pure_durations.csv' u 1:10 w linespoint lc "purple" title 'Quelltextinstrumentierung', \
	'pure_durations.csv' u 1:($10-$11):($10+$11) w filledcurves lc "purple" notitle fs transparent solid 0.5, \
	...
	'pure_durations.csv' u 1:($12-$13):($12+$13) w filledcurves lc "green" notitle fs transparent solid 0.5, \
     'pure_durations.csv' u 1:($14/1000) w linespoint lc "blue" title 'Quelltext-, selektive Instrumentierung und Aggregation', \
	'pure_durations.csv' u 1:($14-$15)/1000:($14+$15)/1000 w filledcurves lc "blue" notitle fs transparent solid 0.5
